-- Dry-Run Seed Script for Baseline Subtype v1
-- This script wraps the generated seed SQL in a transaction and rolls back
-- Generated: 2026-01-16T10:19:43.489Z
-- Source: baseline_subtype_v1_seed.sql
...
-- ============================================================================
-- EXECUTE THE GENERATED SEED SQL
-- ============================================================================
-- Contents from baseline_subtype_v1_seed.sql (INSERT statements only)
...
-- UNIQUENESS CHECK
-- ============================================================================
-- Should be zero rows if you enforce 1 per subtype
...
-- ============================================================================
-- SPOT CHECK: Confirm the new subtype exists post-seed (inside transaction)
-- ============================================================================
SELECT canon_id, discipline_code, subtype_code, left(question_text, 80) AS preview, canon_version
FROM public.baseline_spines_runtime
WHERE subtype_code = 'PER_PEDESTRIAN_ACCESS_CONTROL_POINTS'
LIMIT 5;

-- ============================================================================
-- ROLLBACK (no changes persist)
-- ============================================================================
ROLLBACK;

-- ============================================================================
-- After ROLLBACK, the database returns to its original state.
-- To actually seed, run baseline_subtype_v1_seed.sql directly (without BEGIN/ROLLBACK).
-- ============================================================================
