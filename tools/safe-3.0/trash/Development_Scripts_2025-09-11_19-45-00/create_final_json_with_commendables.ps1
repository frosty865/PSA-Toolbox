# CREATE FINAL JSON WITH CORRECT COMMENDABLE CATEGORIES
...
Write-Host "=== CREATING FINAL JSON WITH CORRECT COMMENDABLE CATEGORIES ===" -ForegroundColor Green
...
$realisticResponses = @{
    ...
    'VideoSystem' = 'no'  # FIX: Added missing video system response
}
...
# Add commendables - FIX: Use valid category values
...
Write-Host "`n=== FINAL JSON WITH CORRECT COMMENDABLE CATEGORIES CREATED ===" -ForegroundColor Green
...
Write-Host "- Added VideoSystem = 'no' response"
