...
export type CisaCommandHeroProps = {
  ...
  /** Right-column panel heading (default: “How it fits”). */
  howItFitsHeading?: string;
  /** When the app uses `basePath` (e.g. `/cisa-site-assessment`), set this so the seal URL resolves. */
  assetBase?: string;
  logoSrc?: string;
  logoAlt?: string;
};
...
/**
 * Shared “page 1” hero: CISA top band, three columns (copy | logo | how it fits), status chips — matches HOST landing pattern.
 */
